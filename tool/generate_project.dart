...
Future<void> _generatePubspecYaml(
  ...
  try {
    ...
    stderr.writeln(
      '❌ Failed to run flutter --version. Ensure Flutter is in PATH.',
    );
    rethrow;
  }
...
''';
  ...
  print('📄 pubspec.yaml created successfully!');
}
...
class AppPreferences {
 ...
 /// ✅ **Save data of any type (`String, int, double, bool, List<String>`)**
 ...
 /// ✅ **Retrieve data (`String, int, double, bool, List<String>`)**
 ...
 /// ✅ **Retrieve list of Models (`List<T>`)**
...
class AppTheme {
 ...
 // 🎨 Helper function to create TextStyle easily
